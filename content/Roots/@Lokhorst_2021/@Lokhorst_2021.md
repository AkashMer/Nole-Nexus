...
Year: 2021
Citekey: Lokhorst_2021
itemType: bookSection
Book: The Stanford Encyclopedia of Philosophy
...
![[pre-cartesian-pineal-gland_dark.svg|mindmap]]\
...
$$
Greek:pneuma\;psychikon\;(psychic\;pneuma) \to Latin:spiritus\;animalis\;(animal\;spirit)
$$

- Niccolò Massa and Andreas Vesalius directly observed the watery nature of the animal spirit using systematic dissections.

## Descartes' model for neurological functions

![[descartes_neurophysiology_dark.svg]]\
*On the surface, this paper is about Descartes' treatment of the pineal gland. But at the core, it's really about how the mechanistic bellows-plus-pineal-gland model successfully links brain to perception, imagination, memory, and voluntary movement, but breaks at the point where these functions must be unified under a rational soul.*  
This model was mechanistically plausible and Descartes was able to describe how each of the neurological functions linked to the movements of the pineal gland:

- **Perception**: 
	- Small fibers within a hollow nerve filled with animal spirits are connected to the valves in the ventricles.
	- These valves are pulled open resulting in the escape of animal spirits from the pressurized ventricles.
	- Low-pressure image of the stimulus appears on the surface of the pineal gland.
- **Imagination**:
	- Similar mechanism as perception but not caused by external stimulus.
	- "Common sense" was given the role of the initiator.
- **Memory**:
	- Flow of animal spirits causes the gaps between tiny fibers of the brain substance to become wider.
	- The flow occurs in different patterns stored in the pineal gland.
- **Bodily Movements**:
	- Pineal gland's movement can open specific valves around it.
...
> 
> **Contribution**: Lokhorst rehabilitates Descartes' model by situating it within the Pre-Cartesian tradition which grounds the model as the most ambitious mechanistic attempt constrained by what was known instead of a naive error.

> [!citation]
> Lokhorst G-J. 2021. Descartes and the Pineal Gland. In: Zalta EN, editor. The Stanford Encyclopedia of Philosophy. Winter 2021. Metaphysics Research Lab, Stanford University [accessed 2026 Mar 17]. [https://plato.stanford.edu/archives/win2021/entries/pineal-gland/](https://plato.stanford.edu/archives/win2021/entries/pineal-gland/)
