...
authors:
  - Rocca, Julius
  - Galen,
Title: "Galen on the brain: anatomical knowledge and physiological speculation in the second century AD"
Year: 2003
citekey: Rocca_2003
itemType: book
Publisher: Brill
...
---
## Galen and his time
![[galen_and_his_time_dark.svg|500]]\
*On the surface, this chapter is about Galen's formative years and the existing philosophies about dissection. But at the core, it's really about Galen trapping rhetoric on dissection-ground, where the anti-dissection sects couldn't follow.*  
The rhetoric-based argumentative methods of antiquity were the most eye-opening element of this chapter. Thus, my focus was to illustrate how Galen fundamentally redirected that rhetoric. His goal was to revive anatomical enquiry after the emergence of Empiricists and Methodists lead to it's decline following the era of Herophilus and Erasistratus. For this purpose, Galen used an approach which involved demonstrations and the securing right benefactors.  
...
My immediate thought upon recognizing this conceptual reversal was how closely it mirrored the reverse transcriptase enzyme. I chose to represent this metaphor by using an upside-down printer that routes output to the bottom tray instead of the top. The two camps are represented by the location of *hegemonikon* with connections to the whole body.  
Rocca provides an extensive landscape of this *hegemonikon* debate spanning seven centuries(from the Presocratics through Alexander of Aphrodisias), positioning Galen within a tradition rather than as an isolated figure.  
## Galen's Methods and Materials
![[galens_methods_meterials_dark.svg]]
*Galen's method: On the surface, this thread is about Galen's clever solution to incorporate his empirical evidence in an Aristotelian first-principles system geometrically. But at the core, it's really about how Galen's geometric-proof framing collapses because he shifted the self-evident truths from logic to the dissector's trained perception.*  
Galen's move mirrors shrouding the approach as something that requires a level of expertise equal only to his. But once this camouflaging curtain is opened, we see the bridge is built on subjective evidence instead of self-evident truths.  

*Galen's materials: On the surface, this thread is about various anatomical substrates used by Galen. But at the core, it's really about how Galen's extrapolated human anatomical claims from animal dissections work against his apodeictic method of proof.*  
...
##### Galen's entire journey has one thing in common: he possessed a powerful weapon, the anatomical investigative framework. By forcing his framework into analogical and teleological reasoning, he obscured the importance of this methodology. Rocca comes to a similar conclusion in this book.


> [!synthesis]
> **Claim**: Galen's anatomical epistemology and research methodology with basis in Aristotelian first principles produced a good basis for anatomical enquiry but fell short of complete physiological description of the brain as the hegemonikon since it was based on analogy, teleological reasoning which were not fully resolved by his experiments.
> 
> **Contribution**: Comprehensive critical review dedicated to Galen's anatomy and physiology of the brain.

> [!citation]
> Rocca J, Galen. 2003. Galen on the brain: anatomical knowledge and physiological speculation in the second century AD. Brill. (Studies in ancient medicine).
